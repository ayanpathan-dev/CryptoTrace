...
def run_pipeline():
    try:
        # Load your dataset
        data = pd.read_csv(r'BTC-dataset1.csv')
        ...
        selected_features = [
            'address_hash', 'Time step', 'first_block_appeared_in', 'last_block_appeared_in', 'lifetime_in_blocks',
            'total_txs', 'first_sent_block', 'first_received_block', 'btc_transacted_total',
            'btc_sent_total', 'btc_received_total', 'fees_total', 'fees_as_share_total',
        ...
        joblib.dump(model, 'BTC-trained_model.pkl')
        joblib.dump(scaler, 'BTC-scaler.pkl')
